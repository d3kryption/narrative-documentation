...
![player-controller-pick-parent-class.webp](//img/player-controller-pick-parent-class.webp)

Now open the **BP_ThirdPersonGameMode** and set the Player Controller class to your newly created **BP_PlayerController**.

![setting-player-controller.webp](//img/setting-player-controller.webp)